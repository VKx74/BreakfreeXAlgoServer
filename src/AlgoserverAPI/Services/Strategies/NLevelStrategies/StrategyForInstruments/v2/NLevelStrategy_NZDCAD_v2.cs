...
{
    public class NLevelStrategy_NZDCAD_v2 : NLevelStrategyBase
    {
        public NLevelStrategy_NZDCAD_v2(StrategyInputContext _context) : base(_context)
        {
        }
        ...
        public override async Task<NLevelStrategyResponse> Calculate()
        {
            var settings = new NLevelStrategySettings
            {
                ...
                CatReflexPeriodReflex = 63,
                CatReflexPeriodSuperSmoother = 101,
                CatReflexPeriodPostSmooth = 126,
                ...
                CatReflexPeriodReflex2 = 46,
                CatReflexPeriodSuperSmoother2 = 136,
                CatReflexPeriodPostSmooth2 = 144,
