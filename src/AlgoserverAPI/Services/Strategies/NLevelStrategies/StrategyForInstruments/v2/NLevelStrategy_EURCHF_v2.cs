...
{
    public class NLevelStrategy_EURCHF_v2 : NLevelStrategyBase
    {
        public NLevelStrategy_EURCHF_v2(StrategyInputContext _context) : base(_context)
        {
        }
        ...
        public override async Task<NLevelStrategyResponse> Calculate()
        {
            var settings = new NLevelStrategySettings
            {
                ...
                CatReflexPeriodReflex = 100,
                CatReflexPeriodSuperSmoother = 113,
                CatReflexPeriodPostSmooth = 72,
                ...
                CatReflexPeriodReflex2 = 50,
                CatReflexPeriodSuperSmoother2 = 122,
                CatReflexPeriodPostSmooth2 = 125,
