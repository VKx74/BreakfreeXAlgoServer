...
{
    public class NLevelStrategy_GBPJPY_v2 : NLevelStrategyBase
    {
        public NLevelStrategy_GBPJPY_v2(StrategyInputContext _context) : base(_context)
        {
        }
        ...
        public override async Task<NLevelStrategyResponse> Calculate()
        {
            var settings = new NLevelStrategySettings
            {
                ...
                CatReflexPeriodSuperSmoother = 49,
                CatReflexPeriodPostSmooth = 69,
                ...
                CatReflexPeriodReflex2 = 42,
                CatReflexPeriodSuperSmoother2 = 80,
                CatReflexPeriodPostSmooth2 = 105,
