...
{
    public class NLevelStrategy_EURNZD_v2 : NLevelStrategyBase
    {
        public NLevelStrategy_EURNZD_v2(StrategyInputContext _context) : base(_context)
        {
        }
        ...
        public override async Task<NLevelStrategyResponse> Calculate()
        {
            var settings = new NLevelStrategySettings
            {
                ...
                CatReflexPeriodReflex2 = 66,
                CatReflexPeriodSuperSmoother2 = 70,
                CatReflexPeriodPostSmooth2 = 44,
