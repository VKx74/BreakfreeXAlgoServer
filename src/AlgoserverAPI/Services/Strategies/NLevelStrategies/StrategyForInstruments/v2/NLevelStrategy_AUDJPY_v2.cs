...
{
    public class NLevelStrategy_AUDJPY_v2 : NLevelStrategyBase
    {
        public NLevelStrategy_AUDJPY_v2(StrategyInputContext _context) : base(_context)
        {
        }
        ...
        public override async Task<NLevelStrategyResponse> Calculate()
        {
            var settings = new NLevelStrategySettings
            {
                ...
                CatReflexPeriodReflex = 37,
                CatReflexPeriodSuperSmoother = 32,
                CatReflexPeriodPostSmooth = 80,
                ...
                CatReflexPeriodReflex2 = 158,
                CatReflexPeriodSuperSmoother2 = 114,
                CatReflexPeriodPostSmooth2 = 112,
