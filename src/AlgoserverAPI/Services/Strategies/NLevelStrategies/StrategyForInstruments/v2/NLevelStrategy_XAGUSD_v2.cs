...
{
    public class NLevelStrategy_XAGUSD_v2 : NLevelStrategyBase
    {
        public NLevelStrategy_XAGUSD_v2(StrategyInputContext _context) : base(_context)
        {
        }
        ...
        public override async Task<NLevelStrategyResponse> Calculate()
        {
            var settings = new NLevelStrategySettings
            {
                ...
                CatReflexPeriodReflex = 107,
                CatReflexPeriodSuperSmoother = 52,
                CatReflexPeriodPostSmooth = 36,
                ...
                CatReflexPeriodReflex2 = 133,
                CatReflexPeriodSuperSmoother2 = 113,
                CatReflexPeriodPostSmooth2 = 176,
