...
{
    public class NLevelStrategy_GBPCAD_v2 : NLevelStrategyBase
    {
        public NLevelStrategy_GBPCAD_v2(StrategyInputContext _context) : base(_context)
        {
        }
        ...
        public override async Task<NLevelStrategyResponse> Calculate()
        {
            var settings = new NLevelStrategySettings
            {
                ...
                CatReflexPeriodReflex2 = 144,
                CatReflexPeriodSuperSmoother2 = 47,
                CatReflexPeriodPostSmooth2 = 85,
