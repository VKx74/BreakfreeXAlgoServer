...
{
    public class NLevelStrategy_EURGBP_v2 : NLevelStrategyBase
    {
        public NLevelStrategy_EURGBP_v2(StrategyInputContext _context) : base(_context)
        {
        }
        ...
        public override async Task<NLevelStrategyResponse> Calculate()
        {
            var settings = new NLevelStrategySettings
            {
                ...
                CatReflexPeriodReflex = 151,
                CatReflexPeriodSuperSmoother = 61,
                CatReflexPeriodPostSmooth = 92,
                ...
                CatReflexPeriodSuperSmoother2 = 111,
                CatReflexPeriodPostSmooth2 = 75,
