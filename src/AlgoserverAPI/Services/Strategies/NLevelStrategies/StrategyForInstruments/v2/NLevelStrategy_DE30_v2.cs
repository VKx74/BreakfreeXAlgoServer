...
{
    public class NLevelStrategy_DE30_v2 : NLevelStrategyBase
    {
        public NLevelStrategy_DE30_v2(StrategyInputContext _context) : base(_context)
        {
        }
        ...
        public override async Task<NLevelStrategyResponse> Calculate()
        {
            var settings = new NLevelStrategySettings
            {
                ...
                CatReflexPeriodReflex = 127,
                CatReflexPeriodSuperSmoother = 68,
                CatReflexPeriodPostSmooth = 31,
                ...
                CatReflexPeriodSuperSmoother2 = 147,
                CatReflexPeriodPostSmooth2 = 163,
