...
{
    public class NLevelStrategy_NZDUSD_v2 : NLevelStrategyBase
    {
        public NLevelStrategy_NZDUSD_v2(StrategyInputContext _context) : base(_context)
        {
        }
        ...
        public override async Task<NLevelStrategyResponse> Calculate()
        {
            var settings = new NLevelStrategySettings
            {
                ...
                CatReflexPeriodSuperSmoother = 44,
                CatReflexPeriodPostSmooth = 10,
                ...
                CatReflexPeriodReflex2 = 156,
                CatReflexPeriodSuperSmoother2 = 122,
                CatReflexPeriodPostSmooth2 = 157,
