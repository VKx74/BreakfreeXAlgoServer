...
{
    public class NLevelStrategy_EURAUD_v2 : NLevelStrategyBase
    {
        public NLevelStrategy_EURAUD_v2(StrategyInputContext _context) : base(_context)
        {
        }
        ...
        public override async Task<NLevelStrategyResponse> Calculate()
        {
            var settings = new NLevelStrategySettings
            {
                ...
                CatReflexPeriodReflex = 161,
                CatReflexPeriodSuperSmoother = 48,
                CatReflexPeriodPostSmooth = 65,
                ...
                CatReflexPeriodSuperSmoother2 = 112,
