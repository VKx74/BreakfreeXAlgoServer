...
{
    public class NLevelStrategy_USDZAR_v2 : NLevelStrategyBase
    {
        public NLevelStrategy_USDZAR_v2(StrategyInputContext _context) : base(_context)
        {
        }
        ...
        public override async Task<NLevelStrategyResponse> Calculate()
        {
            var settings = new NLevelStrategySettings
            {
                ...
                CatReflexPeriodReflex = 94,
                CatReflexPeriodSuperSmoother = 67,
                CatReflexPeriodPostSmooth = 166,
                ...
                CatReflexPeriodReflex2 = 124,
                CatReflexPeriodSuperSmoother2 = 167,
                CatReflexPeriodPostSmooth2 = 8,
