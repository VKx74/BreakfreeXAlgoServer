...
{
    public class NLevelStrategy_AUDUSD_v2 : NLevelStrategyBase
    {
        public NLevelStrategy_AUDUSD_v2(StrategyInputContext _context) : base(_context)
        {
        }
        ...
        public override async Task<NLevelStrategyResponse> Calculate()
        {
            var settings = new NLevelStrategySettings
            {
                ...
                CatReflexPeriodSuperSmoother = 60,
