...
namespace Algoserver.Strategies.NLevelStrategy.V5
{
    ...
    public class NLevelStrategy_BTCUSD_v5 : NLevelStrategyBase
    {
        public NLevelStrategy_BTCUSD_v5(StrategyInputContext _context) : base(_context)
        {
        }
        ...
        public override async Task<NLevelStrategyResponse> Calculate()
        {
            var settings = new NLevelStrategySettings
            {
                ...
                CatReflexPeriodSuperSmoother = 21,
                CatReflexPeriodPostSmooth = 217,
                ...
                CatReflexPeriodReflex2 = 21,
                CatReflexPeriodSuperSmoother2 = 75,
                CatReflexPeriodPostSmooth2 = 117,
                ...
                CatReflexPeriodReflex3 = 171,
                CatReflexPeriodSuperSmoother3 = 87,
                CatReflexPeriodPostSmooth3 = 617,
