...
{
    // Settings version XAUUSD_combined_v6.set
    public class NLevelStrategy_XAUUSD_v6 : NLevelStrategyBase
    {
        public NLevelStrategy_XAUUSD_v6(StrategyInputContext _context) : base(_context)
        {
        }
        ...
        public override async Task<NLevelStrategyResponse> Calculate()
        {
            var settings = new NLevelStrategySettings
            {
                ...
                CatReflexPeriodSuperSmoother = 51,
                ...
                CatReflexPeriodSuperSmoother3 = 3,
                CatReflexPeriodPostSmooth3 = 117,
