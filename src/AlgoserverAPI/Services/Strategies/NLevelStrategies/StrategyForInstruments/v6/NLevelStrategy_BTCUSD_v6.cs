...
namespace Algoserver.Strategies.NLevelStrategy.V6
{
    ...
    public class NLevelStrategy_BTCUSD_v6 : NLevelStrategyBase
    {
        public NLevelStrategy_BTCUSD_v6(StrategyInputContext _context) : base(_context)
        {
        }
        ...
        public override async Task<NLevelStrategyResponse> Calculate()
        {
            var settings = new NLevelStrategySettings
            {
                ...
                CatReflexPeriodReflex3 = 33,
                CatReflexPeriodSuperSmoother3 = 63,
