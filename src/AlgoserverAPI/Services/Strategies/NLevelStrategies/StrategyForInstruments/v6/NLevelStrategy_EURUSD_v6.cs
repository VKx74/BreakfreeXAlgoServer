...
{
    // Settings version EURUSD_combined_v6.set
    public class NLevelStrategy_EURUSD_v6 : NLevelStrategyBase
    {
        public NLevelStrategy_EURUSD_v6(StrategyInputContext _context) : base(_context)
        {
        }
        ...
        public override async Task<NLevelStrategyResponse> Calculate()
        {
            var settings = new NLevelStrategySettings
            {
                ...
                CatReflexPeriodReflex = 75,
                CatReflexPeriodSuperSmoother = 57,
                CatReflexPeriodPostSmooth = 617,
                ...
                CatReflexPeriodReflex3 = 3,
                CatReflexPeriodSuperSmoother3 = 45,
                CatReflexPeriodPostSmooth3 = 317,
