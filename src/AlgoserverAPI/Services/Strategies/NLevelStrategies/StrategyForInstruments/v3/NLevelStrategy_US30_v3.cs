...
{
    public class NLevelStrategy_US30_v3 : NLevelStrategyBase
    {
        public NLevelStrategy_US30_v3(StrategyInputContext _context) : base(_context)
        {
        }
        ...
        public override async Task<NLevelStrategyResponse> Calculate()
        {
            var settings = new NLevelStrategySettings
            {
                ...
                CatReflexPeriodReflex = 61,
                CatReflexPeriodSuperSmoother = 198,
                ...
                CatReflexPeriodReflex2 = 145,
                CatReflexPeriodSuperSmoother2 = 109,
                CatReflexPeriodPostSmooth2 = 235,
