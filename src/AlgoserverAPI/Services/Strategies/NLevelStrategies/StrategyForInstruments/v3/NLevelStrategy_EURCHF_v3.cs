...
{
    public class NLevelStrategy_EURCHF_v3 : NLevelStrategyBase
    {
        public NLevelStrategy_EURCHF_v3(StrategyInputContext _context) : base(_context)
        {
        }
        ...
        public override async Task<NLevelStrategyResponse> Calculate()
        {
            var settings = new NLevelStrategySettings
            {
                ...
                CatReflexPeriodReflex = 244,
                CatReflexPeriodSuperSmoother = 151,
                CatReflexPeriodPostSmooth = 117,
                ...
                CatReflexPeriodSuperSmoother2 = 289,
                CatReflexPeriodPostSmooth2 = 162,
                CatReflexConfirmationPeriod2 = 8,
