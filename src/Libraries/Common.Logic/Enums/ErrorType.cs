...
namespace Common.Logic.Enums
{
    public enum ErrorType
    {
        ...
        [Description("You can not do this operation with yourself")]
        InvalidOperationWithYourself = 171,

        [Description("You are blocked by user")]
        YouAreBlockedByUser = 172
    }
}